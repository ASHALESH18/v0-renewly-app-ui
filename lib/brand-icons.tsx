...
const brandMap: Record<string, BrandConfig> = {
  ...
  jiocinema: {
    ...
    icon: <span className="font-black text-[0.72em]">Jio</span>,
    color: '#E91E63',
    textColor: '#FFFFFF',
  },
  sonyliv: {
    name: 'sonyliv',
    displayName: 'SonyLIV',
    icon: <span className="font-black text-[0.82em]">S</span>,
    color: '#000000',
    textColor: '#FFFFFF',
  },
  zee5: {
    name: 'zee5',
    displayName: 'Zee5',
    icon: <span className="font-black text-[0.82em]">Z</span>,
    color: '#7B2BFF',
    textColor: '#FFFFFF',
  },
  'sun nxt': {
    name: 'sun nxt',
    displayName: 'Sun NXT',
    icon: <span className="font-black text-[0.72em]">SN</span>,
    color: '#F47C20',
    textColor: '#FFFFFF',
  },
  aha: {
    name: 'aha',
    displayName: 'Aha',
    icon: <span className="font-black text-[0.82em]">A</span>,
    color: '#FF6F00',
    textColor: '#FFFFFF',
  },
  hoichoi: {
    name: 'hoichoi',
    displayName: 'Hoichoi',
    icon: <span className="font-black text-[0.82em]">H</span>,
    color: '#E63946',
    textColor: '#FFFFFF',
  },
  'eros now': {
    ...
    icon: <span className="font-black text-[0.72em]">EN</span>,
    color: '#D62828',
    textColor: '#FFFFFF',
  },
  rentomojo: {
    name: 'rentomojo',
    displayName: 'Rentomojo',
    icon: <span className="font-black text-[0.72em]">RM</span>,
    color: '#FF5F1F',
    textColor: '#FFFFFF',
  },
  furlenco: {
    ...
    icon: <span className="font-black text-[0.82em]">F</span>,
    color: '#1A1A1A',
    textColor: '#FFFFFF',
  },
  'ro service': {
    name: 'ro service',
    displayName: 'RO Service',
    icon: <span className="font-black text-[0.72em]">RO</span>,
    color: '#0EA5E9',
    textColor: '#FFFFFF',
  },
  'wifi broadband': {
    name: 'wifi broadband',
    displayName: 'WiFi / Broadband',
    icon: <span className="font-black text-[0.68em]">WiFi</span>,
    color: '#0EA5E9',
    textColor: '#FFFFFF',
  },
  'credit card autopay': {
    name: 'credit card autopay',
    displayName: 'Credit Card Autopay',
    icon: <span className="font-black text-[0.72em]">CC</span>,
    color: '#334155',
    textColor: '#FFFFFF',
  },
...
/**
 * Premium fallback badge with readable initials.
 * This intentionally avoids broken remote logo URLs while keeping every
 * catalog service visually clear in Light, Dark, and Glass themes.
 */
export function FallbackBadge({
  ...
  return (
    <div
      className={`${sizeClasses[size]} rounded-2xl flex items-center justify-center font-bold shrink-0 shadow-sm ring-1 ring-white/20`}
      style={{
        backgroundColor,
