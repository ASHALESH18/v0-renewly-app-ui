            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <Crown className={cn('w-4 h-4', isPremium || isFamilyMember ? 'text-gold' : 'text-muted-foreground')} />
                  <span className={cn('text-xs font-medium', isPremium || isFamilyMember ? 'text-gold' : 'text-muted-foreground')}>
                    {/* S5C-R: Show Family member state instead of Free Plan */}
                    {isFamilyMember ? 'Renewly Family Member' : planName}
                  </span>
                </div>
              </div>
            ...
            <SettingsItem
              ...
              description={
                ...
                isFamilyMember
                  ...
                  : pendingBillingBadgeText || (userProfile?.plan === 'pro' ? 'Pro - Active' : planName)
              }
          ...
          <div className="space-y-6">
            {wasRemovedFromFamily && userProfile?.plan === 'free' ? (
              ...
              <>
                ...
                {/* F7.2F: Start your own plan CTA for members */}
                <button
                  onClick={() => {
