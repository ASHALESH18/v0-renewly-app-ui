...
const THEME_OPTIONS: ThemeOption[] = [
  ...
  },
  {
    ...
    preview: {
      bg: '#0F1220',
      sidebar: '#0C0F1C',
      card: 'rgba(26, 29, 45, 0.78)',
      cardBorder: 'rgba(180, 200, 255, 0.18)',
      text: '#EEF0F8',
      mutedText: '#9BA1B8',
      accent: '#D4B070',
      atmosphere:
        'radial-gradient(ellipse 80% 60% at 20% 20%, rgba(140, 150, 220, 0.28) 0%, transparent 55%), radial-gradient(ellipse 60% 50% at 80% 80%, rgba(170, 140, 200, 0.20) 0%, transparent 55%)',
      cardBackdrop: 'blur(8px) saturate(160%)',
    },
  },
]
